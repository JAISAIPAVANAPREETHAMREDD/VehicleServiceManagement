...
SECRET_KEY = 'django-insecure-85vn2=8y68ga7x2*u9yrju9hgwz=zffv@)y%7=n_2v@^+gscn0'
...
app = Celery('VehicleServiceManagement')
app.config_from_object('django.conf:settings', namespace='CELERY')
# settings.py
CELERY_BROKER_URL = 'redis://localhost:6379/0'  # Use your preferred broker
CELERY_TIMEZONE = 'UTC'
